...
public class StoreKeyStep : IStep
{
    public string Name => "_doorStepName";
    public string Description => "_doorStoreStepDescription";
    ...
    public void Activate()
    {
        ...
        _eventService.Subscribe<OnDoorLocked>(HandleAction);
    }

    public void Deactivate()
    {
        _eventService.Unsubscribe<OnDoorLocked>(HandleAction);
    }
